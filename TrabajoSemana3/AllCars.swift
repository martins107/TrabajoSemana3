...
class AllCars{
    ...
    var cars: CarModel = CarModel.init(cars: [CarService(category: "Sedán", cars: arraySedan), CarService(category: "Turismo", cars: arrayTurismo), CarService(category: "Deportivo", cars: arrayDeportivo)])
    
    init(arraySedan : [Car], arrayTurismo : [Car], arrayDeportivo : [Car], cars : CarModel){
        self.arraySedan = arraySedan
        self.arrayTurismo = arrayTurismo
        self.arrayDeportivo = arrayDeportivo
        self.cars = cars
