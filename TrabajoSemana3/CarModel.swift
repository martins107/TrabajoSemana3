...
class CarModel{
    ...
    func initCars(){
        cars.append(CarService.init(category: "Sedán", cars: arraySedan))
        cars.append(CarService.init(category: "Turismo", cars: arrayTurismo))
        cars.append(CarService.init(category: "Deportivo", cars: arrayDeportivo))
    }
}
